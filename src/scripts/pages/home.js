  ...
  $.get('https://api.rss2json.com/v1/api.json', data, function (response) {
    if (response.status == 'ok') {
      ...
      $.each(response.items, function (k, item) {
        ...
        if (src.indexOf('cdn-images-1') < 0) src = 'http://az616578.vo.msecnd.net/files/2016/06/15/636016285941226674637698081_1127.jpg';

        output += '<div class="blog-element">'
        output += '<a href="' + item.link + '"><img class="img-responsive" src="' + src + '" width="360px" height="240px"></a></div></header>';
